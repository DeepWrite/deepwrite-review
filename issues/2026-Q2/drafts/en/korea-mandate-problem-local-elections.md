...
subtitle: A local election can carry national meaning without becoming a single plebiscite.
slug: korea-mandate-problem-local-elections
issue: 2026-Q2
date: '2026-06-11'
language: en
translation_of: original
counterpart_url: /ko/korea-mandate-problem-local-elections/
authors:
...
- elections
- mandate
abstract: Korea's 2026 local elections should be read neither as a purely local exercise
  nor as a simple national referendum. Wire reports based on election counts described
  the ruling Democratic Party winning most regional races while losing Seoul. The
