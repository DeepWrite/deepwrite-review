...
This article is assigned to the Education Editor with Technology Editor. It must proceed as a magazine article, not a compact briefing skeleton. The public article should carry argument, evidence, cases, and prose; development notes belong here or in review files.

## Central Thesis

Generative AI has made assessment design, not cheating detection, the central institutional problem for universities.

## Korean Thesis Check

생성형 AI는 대학의 핵심 문제를 부정행위 탐지가 아니라 평가 설계로 바꾸었다.
...
AI use rates do not prove learning outcomes. Assessment claims need assignment-level evidence.
