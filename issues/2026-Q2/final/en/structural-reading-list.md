...
subtitle: A source hierarchy for readers who want evidence before mood.
...
- sources
- method
abstract: This reading list models the magazine's method. Start with primary and institutional
  evidence; use forecasts as conditional arguments; use journalism for chronology;
