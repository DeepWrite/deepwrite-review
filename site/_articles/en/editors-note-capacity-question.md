...
subtitle: The issue is not acceleration alone, but whether institutions can absorb
  it.
...
- quarterly theme
abstract: 'The 2026-Q2 issue is organized around a simple claim: the quarter''s important
  events are not only fast, but institutionally demanding. AI, war-shadowed macroeconomics,
