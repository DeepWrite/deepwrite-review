...
subtitle: The headline number fell, but durable displacement remains the structural
  fact.
...
- refugees
- migration
abstract: 'Forced displacement should be read as a stock problem as well as a flow
  problem. UNHCR estimates 117.8 million people were forcibly displaced at the end
  of 2025. The slight decline matters, but the deeper issue is duration: millions
