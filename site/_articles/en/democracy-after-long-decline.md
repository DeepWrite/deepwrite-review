...
subtitle: The danger is not only collapse, but the normalization of institutional
  erosion.
...
- rule of law
- institutions
abstract: 'Democratic decline is no longer best understood as a short emergency. In
  2026 it is a background condition: repeated deterioration in rights, judicial independence,
